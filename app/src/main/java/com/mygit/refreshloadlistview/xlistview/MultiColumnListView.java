...
import com.mygit.refreshloadlistview.xlistview.plalistview.PLA_ListView;
...
public class MultiColumnListView extends PLA_ListView {
    ...
    private void init(AttributeSet attrs) {
        ...
        if (attrs == null) {
            ...
            int landColNumber = a.getInteger(
                    R.styleable.PinterestLikeAdapterView_plaLandscapeColumnNumber, 3);
            int defColNumber = a
                    .getInteger(R.styleable.PinterestLikeAdapterView_plaColumnNumber, 2);
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        columnWidth = (getMeasuredWidth() - mListPadding.left - mListPadding.right
                - mColumnPaddingLeft - mColumnPaddingRight)
                / getColumnNumber();

        for (int index = 0; index < getColumnNumber(); ++index) {
            mColumns[index].mColumnWidth = columnWidth;
            mColumns[index].mColumnLeft = mListPadding.left + mColumnPaddingLeft + columnWidth
                    * index;
        }
