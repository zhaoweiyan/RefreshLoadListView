...
package com.mygit.refreshloadlistview.xlistview.plalistview;
...
public class PLA_ListView extends PLA_AbsListView {
    ...
    /**
     * Sets the data behind this ListView. The adapter passed to this method may
     * be wrapped by a {@link WrapperListAdapter}, depending on the ListView
    ...
    protected void onFocusChanged(boolean gainFocus, int direction, Rect previouslyFocusedRect) {
        ...
        if (DEBUG)
            Log.d("PLA_ListView", "onFocusChanged");
